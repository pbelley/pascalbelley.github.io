...
export default function CVPascalBelleyStyled() {
  return (
        ...
        >
          <div className="max-w-5xl mx-auto p-8 bg-gradient-to-br from-white to-blue-50 space-y-8">
            ...
            <div className="flex flex-col items-center text-center">
              <h1 className="text-4xl font-extrabold text-blue-900">Pascal Belley</h1>
              <div className="mt-4 flex flex-wrap justify-center gap-4 text-sm text-blue-700">
                <span className="flex items-center gap-2"><Phone size={16} /> (418) 928-2242</span>
                <a href="mailto:lpbelley@gmail.com">
                  <span className="flex items-center gap-2"><Mail size={16} /> pbelley@gmail.com</span>
                </a>
                <a href="https://www.linkedin.com/in/pascal-belley-464815231/">
                  <span className="flex items-center gap-2"><Linkedin size={16} /> linkedin.com/in/pascal-belley</span>
                </a>
                <span className="flex items-center gap-2"><MapPin size={16} /> Saint-Casimir, QC</span>
              </div>
            </div>
